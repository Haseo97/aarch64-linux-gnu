...
#endif
#ifdef GENERATOR_FILE
extern int flag_broken_callers;
#else
  int x_flag_broken_callers;
#define flag_broken_callers global_options.x_flag_broken_callers
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_Wformat_diag = 251,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 252,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 253,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 254, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 255,               /* -Wformat-overflow= */
  OPT_Wformat_security = 256,                /* -Wformat-security */
  OPT_Wformat_signedness = 257,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 258, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 259,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 260,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 261,             /* -Wformat-zero-length */
  OPT_Wformat_ = 262,                        /* -Wformat= */
  OPT_Wframe_address = 263,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 264,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 265,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 266,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 267,           /* -Wfunction-elimination */
  OPT_Whsa = 268,                            /* -Whsa */
  OPT_Wif_not_aligned = 269,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 270,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 271,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 272,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 273, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 274,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 275,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 276,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 277,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 278,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 279, */                   /* -Wimport */
  OPT_Wincompatible_pointer_types = 280,     /* -Wincompatible-pointer-types */
  OPT_Winherited_variadic_ctor = 281,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 282,             /* -Winit-list-lifetime */
  OPT_Winit_self = 283,                      /* -Winit-self */
  OPT_Winline = 284,                         /* -Winline */
  OPT_Wint_conversion = 285,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 286,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 287,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 288,               /* -Winteger-division */
  OPT_Wintrinsic_shadow = 289,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 290,                 /* -Wintrinsics-std */
  OPT_Winvalid_memory_model = 291,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 292,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 293,                    /* -Winvalid-pch */
  OPT_Wjump_misses_init = 294,               /* -Wjump-misses-init */
  OPT_Wl_ = 295,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 296, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 297,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 298,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 299,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 300,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 301,                     /* -Wlogical-op */
  OPT_Wlong_long = 302,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 303,              /* -Wlto-type-mismatch */
  OPT_Wmain = 304,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 305,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 306,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 307,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 308,         /* -Wmisleading-indentation */
  OPT_Wmissing_attributes = 309,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 310,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 311,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 312,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 313, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 314,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 315, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 316,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 317,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 318,             /* -Wmissing-prototypes */
  OPT_Wmudflap = 319,                        /* -Wmudflap */
  OPT_Wmultichar = 320,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 321,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 322,          /* -Wmultistatement-macros */
  OPT_Wnamespaces = 323,                     /* -Wnamespaces */
  OPT_Wnarrowing = 324,                      /* -Wnarrowing */
  OPT_Wnested_externs = 325,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 326, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 327, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_vla_larger_than = 328, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 329,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 330,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 331,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 332,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 333,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 334,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 335, */               /* -Wnormalized */
  OPT_Wnormalized_ = 336,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 337,               /* -Wnull-dereference */
  OPT_Wodr = 338,                            /* -Wodr */
  OPT_Wold_style_cast = 339,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 340,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 341,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 342,                    /* -Wopenmp-simd */
  OPT_Woverflow = 343,                       /* -Woverflow */
  OPT_Woverlength_strings = 344,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 345,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 346,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 347,     /* -Woverride-init-side-effects */
  OPT_Wp_ = 348,                             /* -Wp, */
  OPT_Wpacked = 349,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 350,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 351,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 352,                         /* -Wpadded */
  OPT_Wparentheses = 353,                    /* -Wparentheses */
  OPT_Wpedantic = 354,                       /* -Wpedantic */
  ...
  OPT_defined_only = 496,                    /* -defined-only */
  OPT_demangle = 497,                        /* -demangle */
  OPT_dstartfiles = 498,                     /* -dstartfiles */
  OPT_dump_body_ = 499,                      /* -dump-body= */
  OPT_dump_level_ = 500,                     /* -dump-level= */
  OPT_dumpbase = 501,                        /* -dumpbase */
  OPT_dumpdir = 502,                         /* -dumpdir */
  OPT_dumpfullversion = 503,                 /* -dumpfullversion */
  OPT_dumpmachine = 504,                     /* -dumpmachine */
  OPT_dumpspecs = 505,                       /* -dumpspecs */
  OPT_dumpversion = 506,                     /* -dumpversion */
  OPT_e = 507,                               /* -e */
  OPT_export_dynamic = 508,                  /* -export-dynamic */
  OPT_fPIC = 509,                            /* -fPIC */
  OPT_fPIE = 510,                            /* -fPIE */
  OPT_fRTS_ = 511,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 512,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 513,                   /* -fabi-version= */
  OPT_faccess_control = 514,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 515,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 516,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 517,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 518,                  /* -falign-commons */
  OPT_falign_functions = 519,                /* -falign-functions */
  OPT_falign_functions_ = 520,               /* -falign-functions= */
  OPT_falign_jumps = 521,                    /* -falign-jumps */
  OPT_falign_jumps_ = 522,                   /* -falign-jumps= */
  OPT_falign_labels = 523,                   /* -falign-labels */
  OPT_falign_labels_ = 524,                  /* -falign-labels= */
  OPT_falign_loops = 525,                    /* -falign-loops */
  OPT_falign_loops_ = 526,                   /* -falign-loops= */
  /* OPT_faligned_new = 527, */              /* -faligned-new */
  OPT_faligned_new_ = 528,                   /* -faligned-new= */
  OPT_fall_instantiations = 529,             /* -fall-instantiations */
  OPT_fall_intrinsics = 530,                 /* -fall-intrinsics */
  OPT_fall_virtual = 531,                    /* -fall-virtual */
  OPT_fallow_leading_underscore = 532,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 533,/* -fallow-parameterless-variadic-functions */
  OPT_falt_external_templates = 534,         /* -falt-external-templates */
  /* OPT_fargument_alias = 535, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 536, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 537, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 538, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 539,            /* -fasan-shadow-offset= */
  OPT_fasm = 540,                            /* -fasm */
  OPT_fassert = 541,                         /* -fassert */
  OPT_fassociative_math = 542,               /* -fassociative-math */
  OPT_fassume_phsa = 543,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 544,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 545,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 546,                   /* -fauto-profile */
  OPT_fauto_profile_ = 547,                  /* -fauto-profile= */
  OPT_fautomatic = 548,                      /* -fautomatic */
  OPT_fbackslash = 549,                      /* -fbackslash */
  OPT_fbacktrace = 550,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 551,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 552,                   /* -fbounds-check */
  OPT_fbounds_check_ = 553,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 554,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 555,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 556,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 557,   /* -fbranch-target-load-optimize2 */
  OPT_fbroken_callers = 558,                 /* -fbroken-callers */
  OPT_fbtr_bb_exclusive = 559,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 560,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 561,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 562,                        /* -fbuiltin */
  OPT_fbuiltin_ = 563,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 564,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 565,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 566,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 567,                    /* -fcall-saved- */
  OPT_fcall_used_ = 568,                     /* -fcall-used- */
  OPT_fcaller_saves = 569,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 570,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 571, */            /* -fcf-protection */
  OPT_fcf_protection_ = 572,                 /* -fcf-protection= */
  OPT_fchar8_t = 573,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 574,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 575, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 576,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 577,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 578,                         /* -fcheck= */
  OPT_fchecking = 579,                       /* -fchecking */
  OPT_fchecking_ = 580,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 581,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 582,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 583,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 584,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 585,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 586,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 587,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 588,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 589, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 590,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 591,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 592,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 593, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 594,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 595,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 596,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 597,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 598,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 599, */                 /* -fcilkplus */
  OPT_fcoarray_ = 600,                       /* -fcoarray= */
  OPT_fcode_hoisting = 601,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 602,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 603,                         /* -fcommon */
  OPT_fcompare_debug = 604,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 605,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 606,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 607,                   /* -fcompare-elim */
  OPT_fconcepts = 608,                       /* -fconcepts */
  OPT_fcond_mismatch = 609,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 610, */           /* -fconserve-space */
  OPT_fconserve_stack = 611,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 612,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 613,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 614,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 615,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 616,                       /* -fconvert= */
  OPT_fcprop_registers = 617,                /* -fcprop-registers */
  OPT_fcray_pointer = 618,                   /* -fcray-pointer */
  OPT_fcrossjumping = 619,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 620,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 621, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 622,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 623,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 624,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 625,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 626,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 627,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 628,                       /* -fdbg-cnt= */
  OPT_fdce = 629,                            /* -fdce */
  OPT_fdebug = 630,                          /* -fdebug */
  OPT_fdebug_cpp = 631,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 632,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 633,            /* -fdebug-types-section */
  OPT_fdebug_ = 634,                         /* -fdebug= */
  OPT_fdec = 635,                            /* -fdec */
  OPT_fdec_format_defaults = 636,            /* -fdec-format-defaults */
  OPT_fdec_include = 637,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 638,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 639,                       /* -fdec-math */
  OPT_fdec_static = 640,                     /* -fdec-static */
  OPT_fdec_structure = 641,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 642,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 643,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 644,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 645, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 646,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 647,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 648,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 649,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 650,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 651,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 652,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 653,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 654,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 655,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 656,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 657, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 658,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 659,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 660,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 661,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 662,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 663,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_labels = 664,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 665,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 666,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 667,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 668, /* -fdiagnostics-show-template-tree */
  OPT_fdirectives_only = 669,                /* -fdirectives-only */
  OPT_fdisable_ = 670,                       /* -fdisable- */
  OPT_fdoc = 671,                            /* -fdoc */
  OPT_fdoc_dir_ = 672,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 673,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 674,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 675,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 676,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 677,                       /* -fdruntime */
  OPT_fdse = 678,                            /* -fdse */
  OPT_fdump_ = 679,                          /* -fdump- */
  OPT_fdump_ada_spec = 680,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 681,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 682, */                /* -fdump-core */
  OPT_fdump_d_original = 683,                /* -fdump-d-original */
  OPT_fdump_final_insns = 684,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 685,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 686,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 687,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 688,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 689,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 690,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 691, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 692,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 693,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 694,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 695,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 696,                 /* -fearly-inlining */
  OPT_felide_constructors = 697,             /* -felide-constructors */
  OPT_felide_type = 698,                     /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 699, */    /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 700, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 701,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 702,        /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 703,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 704,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 705,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 706,                        /* -fenable- */
  OPT_fenforce_eh_specs = 707,               /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 708,                 /* -fenum-int-equiv */
  OPT_fexceptions = 709,                     /* -fexceptions */
  OPT_fexcess_precision_ = 710,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 711,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 712,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 713,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 714,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 715,                /* -fextern-tls-init */
  OPT_fexternal_blas = 716,                  /* -fexternal-blas */
  OPT_fexternal_templates = 717,             /* -fexternal-templates */
  OPT_ff2c = 718,                            /* -ff2c */
  OPT_ffast_math = 719,                      /* -ffast-math */
  OPT_ffat_lto_objects = 720,                /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 721,               /* -ffile-prefix-map= */
  OPT_ffinite_math_only = 722,               /* -ffinite-math-only */
  OPT_ffixed_ = 723,                         /* -ffixed- */
  OPT_ffixed_form = 724,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 725,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 726,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 727,                    /* -ffloat-store */
  OPT_ffor_scope = 728,                      /* -ffor-scope */
  /* OPT_fforce_addr = 729, */               /* -fforce-addr */
  OPT_fforward_propagate = 730,              /* -fforward-propagate */
  OPT_ffp_contract_ = 731,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 732,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 733,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 734,                      /* -ffpe-trap= */
  OPT_ffree_form = 735,                      /* -ffree-form */
  OPT_ffree_line_length_ = 736,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 737,          /* -ffree-line-length-none */
  OPT_ffreestanding = 738,                   /* -ffreestanding */
  OPT_ffriend_injection = 739,               /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 740,      /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 741,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 742,                   /* -ffunction-cse */
  OPT_ffunction_sections = 743,              /* -ffunction-sections */
  OPT_fgcse = 744,                           /* -fgcse */
  OPT_fgcse_after_reload = 745,              /* -fgcse-after-reload */
  OPT_fgcse_las = 746,                       /* -fgcse-las */
  OPT_fgcse_lm = 747,                        /* -fgcse-lm */
  OPT_fgcse_sm = 748,                        /* -fgcse-sm */
  OPT_fgimple = 749,                         /* -fgimple */
  OPT_fgnat_encodings_ = 750,                /* -fgnat-encodings= */
  ...
  OPT_fgo_c_header_ = 756,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 757,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 758,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 759,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 760,                /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 761,          /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 762,          /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 763,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 764,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 765,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 766,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 767,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 768,                       /* -fgraphite */
  OPT_fgraphite_identity = 769,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 770,       /* -fguess-branch-probability */
  OPT_fguiding_decls = 771,                  /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 772, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 773, */                     /* -fhelp */
  /* OPT_fhelp_ = 774, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 775,           /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 776,                      /* -fhonor-std */
  OPT_fhosted = 777,                         /* -fhosted */
  OPT_fhuge_objects = 778,                   /* -fhuge-objects */
  OPT_fident = 779,                          /* -fident */
  OPT_fif_conversion = 780,                  /* -fif-conversion */
  OPT_fif_conversion2 = 781,                 /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 782,         /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 783,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 784,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 785,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 786,             /* -fimplicit-templates */
  OPT_findirect_inlining = 787,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 788,         /* -finhibit-size-directive */
  OPT_finit_character_ = 789,                /* -finit-character= */
  OPT_finit_derived = 790,                   /* -finit-derived */
  OPT_finit_integer_ = 791,                  /* -finit-integer= */
  OPT_finit_local_zero = 792,                /* -finit-local-zero */
  OPT_finit_logical_ = 793,                  /* -finit-logical= */
  OPT_finit_real_ = 794,                     /* -finit-real= */
  OPT_finline = 795,                         /* -finline */
  OPT_finline_atomics = 796,                 /* -finline-atomics */
  OPT_finline_functions = 797,               /* -finline-functions */
  OPT_finline_functions_called_once = 798,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 799, */            /* -finline-limit- */
  OPT_finline_limit_ = 800,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 801,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 802,         /* -finline-small-functions */
  OPT_finput_charset_ = 803,                 /* -finput-charset= */
  OPT_finstrument_functions = 804,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 805,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 806,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 807,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 808,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 809,        /* -fintrinsic-modules-path= */
  OPT_finvariants = 810,                     /* -finvariants */
  OPT_fipa_bit_cp = 811,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 812,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 813, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 814,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 815,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 816,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 817,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 818, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 819,                    /* -fipa-profile */
  OPT_fipa_pta = 820,                        /* -fipa-pta */
  OPT_fipa_pure_const = 821,                 /* -fipa-pure-const */
  OPT_fipa_ra = 822,                         /* -fipa-ra */
  OPT_fipa_reference = 823,                  /* -fipa-reference */
  OPT_fipa_reference_addressable = 824,      /* -fipa-reference-addressable */
  OPT_fipa_sra = 825,                        /* -fipa-sra */
  OPT_fipa_stack_alignment = 826,            /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 827, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 828,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 829,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 830,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 831,              /* -fira-loop-pressure */
  OPT_fira_region_ = 832,                    /* -fira-region= */
  OPT_fira_share_save_slots = 833,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 834,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 835,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 836,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 837,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 838,               /* -fivar-visibility= */
  OPT_fivopts = 839,                         /* -fivopts */
  OPT_fjump_tables = 840,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 841,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 842,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 843,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 844,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 845,          /* -fkeep-static-functions */
  OPT_flabels_ok = 846,                      /* -flabels-ok */
  OPT_flax_vector_conversions = 847,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 848,             /* -fleading-underscore */
  OPT_flifetime_dse = 849,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 850,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 851,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 852,                 /* -flinker-output= */
  /* OPT_flive_patching = 853, */            /* -flive-patching */
  OPT_flive_patching_ = 854,                 /* -flive-patching= */
  OPT_flive_range_shrinkage = 855,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 856,                    /* -flocal-ivars */
  /* OPT_floop_block = 857, */               /* -floop-block */
  /* OPT_floop_flatten = 858, */             /* -floop-flatten */
  OPT_floop_interchange = 859,               /* -floop-interchange */
  OPT_floop_nest_optimize = 860,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 861, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 862,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 863, */          /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 864,            /* -floop-unroll-and-jam */
  OPT_flra_remat = 865,                      /* -flra-remat */
  OPT_flto = 866,                            /* -flto */
  OPT_flto_compression_level_ = 867,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 868,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 869,                 /* -flto-partition= */
  OPT_flto_report = 870,                     /* -flto-report */
  OPT_flto_report_wpa = 871,                 /* -flto-report-wpa */
  OPT_flto_ = 872,                           /* -flto= */
  OPT_fltrans = 873,                         /* -fltrans */
  OPT_fltrans_output_list_ = 874,            /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 875,              /* -fmacro-prefix-map= */
  OPT_fmain = 876,                           /* -fmain */
  OPT_fmath_errno = 877,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 878,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 879,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 880,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 881,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 882,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 883,                     /* -fmem-report */
  OPT_fmem_report_wpa = 884,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 885,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 886,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 887,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 888,                /* -fmessage-length= */
  OPT_fmodule_file_ = 889,                   /* -fmodule-file= */
  OPT_fmodule_private = 890,                 /* -fmodule-private */
  OPT_fmoduleinfo = 891,                     /* -fmoduleinfo */
  OPT_fmodulo_sched = 892,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 893,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 894,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 895,                  /* -fms-extensions */
  OPT_fmudflap = 896,                        /* -fmudflap */
  OPT_fmudflapir = 897,                      /* -fmudflapir */
  OPT_fmudflapth = 898,                      /* -fmudflapth */
  OPT_fname_mangling_version_ = 899,         /* -fname-mangling-version- */
  OPT_fnew_abi = 900,                        /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 901,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 902,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 903,                   /* -fnext-runtime */
  OPT_fnil_receivers = 904,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 905,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 906,               /* -fnonansi-builtins */
  OPT_fnonnull_objects = 907,                /* -fnonnull-objects */
  OPT_fnothrow_opt = 908,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 909,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 910,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 911,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 912,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 913,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 914,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 915,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 916,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 917,                   /* -foffload-abi= */
  OPT_foffload_ = 918,                       /* -foffload= */
  OPT_fomit_frame_pointer = 919,             /* -fomit-frame-pointer */
  OPT_fonly_ = 920,                          /* -fonly= */
  OPT_fopenacc = 921,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 922,                   /* -fopenacc-dim= */
  OPT_fopenmp = 923,                         /* -fopenmp */
  OPT_fopenmp_simd = 924,                    /* -fopenmp-simd */
  OPT_foperator_names = 925,                 /* -foperator-names */
  OPT_fopt_info = 926,                       /* -fopt-info */
  OPT_fopt_info_ = 927,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 928, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 929,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 930,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 931, */           /* -foptional-diags */
  OPT_fpack_derived = 932,                   /* -fpack-derived */
  OPT_fpack_struct = 933,                    /* -fpack-struct */
  OPT_fpack_struct_ = 934,                   /* -fpack-struct= */
  OPT_fpad_source = 935,                     /* -fpad-source */
  OPT_fpartial_inlining = 936,               /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 937,      /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 938,              /* -fpcc-struct-return */
  OPT_fpch_deps = 939,                       /* -fpch-deps */
  OPT_fpch_preprocess = 940,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 941,                     /* -fpeel-loops */
  OPT_fpeephole = 942,                       /* -fpeephole */
  OPT_fpeephole2 = 943,                      /* -fpeephole2 */
  OPT_fpermissive = 944,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 945,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 946,                            /* -fpic */
  OPT_fpie = 947,                            /* -fpie */
  OPT_fplan9_extensions = 948,               /* -fplan9-extensions */
  OPT_fplt = 949,                            /* -fplt */
  OPT_fplugin_arg_ = 950,                    /* -fplugin-arg- */
  OPT_fplugin_ = 951,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 952,            /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 953,                 /* -fpostconditions */
  OPT_fpre_include_ = 954,                   /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 955,             /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 956,                  /* -fpreconditions */
  OPT_fpredictive_commoning = 957,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 958,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 959,                   /* -fpreprocessed */
  OPT_fpretty_templates = 960,               /* -fpretty-templates */
  OPT_fprintf_return_value = 961,            /* -fprintf-return-value */
  OPT_fprofile = 962,                        /* -fprofile */
  OPT_fprofile_abs_path = 963,               /* -fprofile-abs-path */
  OPT_fprofile_arcs = 964,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 965,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 966,                   /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 967,         /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 968,          /* -fprofile-filter-files= */
  OPT_fprofile_generate = 969,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 970,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 971,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 972,                 /* -fprofile-report */
  OPT_fprofile_update_ = 973,                /* -fprofile-update= */
  OPT_fprofile_use = 974,                    /* -fprofile-use */
  OPT_fprofile_use_ = 975,                   /* -fprofile-use= */
  OPT_fprofile_values = 976,                 /* -fprofile-values */
  OPT_fprotect_parens = 977,                 /* -fprotect-parens */
  OPT_frandom_seed = 978,                    /* -frandom-seed */
  OPT_frandom_seed_ = 979,                   /* -frandom-seed= */
  OPT_frange_check = 980,                    /* -frange-check */
  OPT_freal_4_real_10 = 981,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 982,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 983,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 984,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 985,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 986,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 987,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 988,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 989,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 990,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 991,                /* -frecord-marker=8 */
  OPT_frecursive = 992,                      /* -frecursive */
  OPT_free = 993,                            /* -free */
  OPT_freg_struct_return = 994,              /* -freg-struct-return */
  /* OPT_fregmove = 995, */                  /* -fregmove */
  OPT_frelease = 996,                        /* -frelease */
  OPT_frename_registers = 997,               /* -frename-registers */
  OPT_freorder_blocks = 998,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 999,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1000,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1001,             /* -freorder-functions */
  OPT_frepack_arrays = 1002,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1003,          /* -freplace-objc-classes */
  OPT_frepo = 1004,                          /* -frepo */
  OPT_freport_bug = 1005,                    /* -freport-bug */
  OPT_frequire_return_statement = 1006,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1007,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1008, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1009,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1010,                   /* -fresolution= */
  OPT_frounding_math = 1011,                 /* -frounding-math */
  OPT_frtti = 1012,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1013,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1014,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1015,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1016,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1017,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1018,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1019,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1020,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1021, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1022,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1023,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1024,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1025,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1026,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1027,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1028,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1029,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1030,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1031,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1032,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1033,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1034,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1035,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1036,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1037,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1038, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1039,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1040,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1041,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1042,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1043,               /* -fsection-anchors */
  /* OPT_fsee = 1044, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1045,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1046,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1047,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1048,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1049,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1050,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1051,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1052,                   /* -fshort-enums */
  OPT_fshort_wchar = 1053,                   /* -fshort-wchar */
  OPT_fshow_column = 1054,                   /* -fshow-column */
  OPT_fshrink_wrap = 1055,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1056,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1057,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1058,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1059,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1060,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1061,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1062,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1063,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1064,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1065,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1066,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1067,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1068,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1069,              /* -fsplit-wide-types */
  OPT_fsquangle = 1070,                      /* -fsquangle */
  OPT_fssa_backprop = 1071,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1072,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1073,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1074,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1075, */             /* -fstack-check */
  OPT_fstack_check_ = 1076,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1077,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1078,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1079,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1080,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1081,               /* -fstack-protector */
  OPT_fstack_protector_all = 1082,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1083,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1084,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1085,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1086,                   /* -fstack-usage */
  OPT_fstats = 1087,                         /* -fstats */
  OPT_fstdarg_opt = 1088,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1089,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1090, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1091,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1092,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1093,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1094,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1095,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1096, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1097,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1098,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1099,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1100,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1101,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1102, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1103,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1104, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1105,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1106,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1107,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1108,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1109,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1110,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1111,                   /* -ftime-report */
  OPT_ftime_report_details = 1112,           /* -ftime-report-details */
  OPT_ftls_model_ = 1113,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1114,              /* -ftoplevel-reorder */
  OPT_ftracer = 1115,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1116,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1117,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1118,                   /* -ftrampolines */
  OPT_ftransition_all = 1119,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1120,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1121,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1122,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1123,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1124,              /* -ftransition=field */
  OPT_ftransition_import = 1125,             /* -ftransition=import */
  OPT_ftransition_nogc = 1126,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1127,                /* -ftransition=tls */
  OPT_ftrapping_math = 1128,                 /* -ftrapping-math */
  OPT_ftrapv = 1129,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1130,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1131,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1132,                      /* -ftree-ccp */
  OPT_ftree_ch = 1133,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1134, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1135,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1136,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1137, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1138,                   /* -ftree-cselim */
  OPT_ftree_dce = 1139,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1140,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1141,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1142,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1143,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1144, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1145,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1146,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1147, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1148,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1149,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1150, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1151,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1152,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1153,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1154,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1155,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1156,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1157,                      /* -ftree-pre */
  OPT_ftree_pta = 1158,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1159,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1160, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1161,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1162,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1163,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1164,                     /* -ftree-slsr */
  OPT_ftree_sra = 1165,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1166, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1167, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1168,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1169,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1170,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1171, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1172,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1173, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1174,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1175,         /* -funconstrained-commons */
  OPT_funderscoring = 1176,                  /* -funderscoring */
  OPT_funit_at_a_time = 1177,                /* -funit-at-a-time */
  OPT_funittest = 1178,                      /* -funittest */
  OPT_funroll_all_loops = 1179,              /* -funroll-all-loops */
  OPT_funroll_loops = 1180,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1181, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1182,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1183,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1184,                 /* -funsigned-char */
  OPT_funswitch_loops = 1185,                /* -funswitch-loops */
  OPT_funwind_tables = 1186,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1187,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1188,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1189,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1190,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1191,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1192,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1193,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1194,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1195,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1196,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1197,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1198, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1199,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1200,                   /* -fverbose-asm */
  /* OPT_fversion = 1201, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1202,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1203,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1204,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1205,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1206,                   /* -fvisibility= */
  OPT_fvpt = 1207,                           /* -fvpt */
  OPT_fvtable_gc = 1208,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1209,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1210,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1211,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1212,                     /* -fvtv-debug */
  OPT_fweak = 1213,                          /* -fweak */
  OPT_fweb = 1214,                           /* -fweb */
  /* OPT_fwhole_file = 1215, */              /* -fwhole-file */
  OPT_fwhole_program = 1216,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1217,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1218,             /* -fworking-directory */
  OPT_fwpa = 1219,                           /* -fwpa */
  OPT_fwpa_ = 1220,                          /* -fwpa= */
  OPT_fwrapv = 1221,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1222,                 /* -fwrapv-pointer */
  OPT_fxref = 1223,                          /* -fxref */
  /* OPT_fzee = 1224, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1225,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1226,                     /* -fzero-link */
  OPT_g = 1227,                              /* -g */
  OPT_gant = 1228,                           /* -gant */
  OPT_gas_loc_support = 1229,                /* -gas-loc-support */
  OPT_gas_locview_support = 1230,            /* -gas-locview-support */
  OPT_gcoff = 1231,                          /* -gcoff */
  OPT_gcoff1 = 1232,                         /* -gcoff1 */
  OPT_gcoff2 = 1233,                         /* -gcoff2 */
  OPT_gcoff3 = 1234,                         /* -gcoff3 */
  OPT_gcolumn_info = 1235,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1236,                 /* -gdescribe-dies */
  OPT_gdwarf = 1237,                         /* -gdwarf */
  OPT_gdwarf_ = 1238,                        /* -gdwarf- */
  OPT_gen_decls = 1239,                      /* -gen-decls */
  OPT_ggdb = 1240,                           /* -ggdb */
  OPT_ggnu_pubnames = 1241,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1242,                   /* -gimple-stats */
  OPT_ginline_points = 1243,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1244, /* -ginternal-reset-location-views */
  OPT_gnat = 1245,                           /* -gnat */
  OPT_gnatO = 1246,                          /* -gnatO */
  OPT_gno_ = 1247,                           /* -gno- */
  OPT_gno_pubnames = 1248,                   /* -gno-pubnames */
  OPT_gpubnames = 1249,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1250,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1251,                   /* -gsplit-dwarf */
  OPT_gstabs = 1252,                         /* -gstabs */
  OPT_gstabs_ = 1253,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1254,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1255,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1256,                        /* -gtoggle */
  OPT_gvariable_location_views = 1257,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1258,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1259,                           /* -gvms */
  OPT_gxcoff = 1260,                         /* -gxcoff */
  OPT_gxcoff_ = 1261,                        /* -gxcoff+ */
  OPT_gz = 1262,                             /* -gz */
  OPT_gz_ = 1263,                            /* -gz= */
  OPT_h = 1264,                              /* -h */
  OPT_help = 1265,                           /* -help */
  OPT_idirafter = 1266,                      /* -idirafter */
  OPT_imacros = 1267,                        /* -imacros */
  OPT_imultiarch = 1268,                     /* -imultiarch */
  OPT_imultilib = 1269,                      /* -imultilib */
  OPT_include = 1270,                        /* -include */
  OPT_iplugindir_ = 1271,                    /* -iplugindir= */
  OPT_iprefix = 1272,                        /* -iprefix */
  OPT_iquote = 1273,                         /* -iquote */
  OPT_isysroot = 1274,                       /* -isysroot */
  OPT_isystem = 1275,                        /* -isystem */
  OPT_iwithprefix = 1276,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1277,              /* -iwithprefixbefore */
  OPT_k8 = 1278,                             /* -k8 */
  OPT_l = 1279,                              /* -l */
  OPT_lang_asm = 1280,                       /* -lang-asm */
  OPT_list = 1281,                           /* -list */
  OPT_mabi_ = 1282,                          /* -mabi= */
  OPT_march_ = 1283,                         /* -march= */
  OPT_mbig_endian = 1284,                    /* -mbig-endian */
  OPT_mbionic = 1285,                        /* -mbionic */
  OPT_mbranch_protection_ = 1286,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1287,                       /* -mcmodel= */
  OPT_mcpu_ = 1288,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1289,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1290,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1291,             /* -mgeneral-regs-only */
  OPT_mglibc = 1292,                         /* -mglibc */
  OPT_mlittle_endian = 1293,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1294,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1295,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1296,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1297,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1298,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1299,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1300,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1301,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1302, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1303,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1304,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1305,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1306,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1307,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1308,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1309,             /* -mtrack-speculation */
  OPT_mtune_ = 1310,                         /* -mtune= */
  OPT_muclibc = 1311,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1312,             /* -mverbose-cost-dump */
  OPT_n = 1313,                              /* -n */
  OPT_name_sort = 1314,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1315,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1316,              /* -no-integrated-cpp */
  OPT_no_pie = 1317,                         /* -no-pie */
  OPT_nocpp = 1318,                          /* -nocpp */
  OPT_nodefaultlibs = 1319,                  /* -nodefaultlibs */
  OPT_nolibc = 1320,                         /* -nolibc */
  OPT_nophoboslib = 1321,                    /* -nophoboslib */
  OPT_nostartfiles = 1322,                   /* -nostartfiles */
  OPT_nostdinc = 1323,                       /* -nostdinc */
  OPT_nostdinc__ = 1324,                     /* -nostdinc++ */
  OPT_nostdlib = 1325,                       /* -nostdlib */
  OPT_o = 1326,                              /* -o */
  OPT_objects = 1327,                        /* -objects */
  OPT_p = 1328,                              /* -p */
  OPT_pass_exit_codes = 1329,                /* -pass-exit-codes */
  /* OPT_pedantic = 1330, */                 /* -pedantic */
  OPT_pedantic_errors = 1331,                /* -pedantic-errors */
  OPT_pg = 1332,                             /* -pg */
  OPT_pie = 1333,                            /* -pie */
  OPT_pipe = 1334,                           /* -pipe */
  OPT_posix = 1335,                          /* -posix */
  OPT_print_file_name_ = 1336,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1337,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1338,          /* -print-multi-directory */
  OPT_print_multi_lib = 1339,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1340,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1341,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1342,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1343,               /* -print-prog-name= */
  OPT_print_search_dirs = 1344,              /* -print-search-dirs */
  OPT_print_sysroot = 1345,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1346,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1347,                    /* -print-value */
  OPT_profile = 1348,                        /* -profile */
  OPT_pthread = 1349,                        /* -pthread */
  OPT_quiet = 1350,                          /* -quiet */
  OPT_r = 1351,                              /* -r */
  OPT_rdynamic = 1352,                       /* -rdynamic */
  OPT_remap = 1353,                          /* -remap */
  OPT_reverse_sort = 1354,                   /* -reverse-sort */
  OPT_s = 1355,                              /* -s */
  OPT_save_temps = 1356,                     /* -save-temps */
  OPT_save_temps_ = 1357,                    /* -save-temps= */
  OPT_shared = 1358,                         /* -shared */
  OPT_shared_libgcc = 1359,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1360,               /* -shared-libphobos */
  OPT_size_sort = 1361,                      /* -size-sort */
  /* OPT_specs = 1362, */                    /* -specs */
  OPT_specs_ = 1363,                         /* -specs= */
  OPT_static = 1364,                         /* -static */
  OPT_static_libasan = 1365,                 /* -static-libasan */
  OPT_static_libgcc = 1366,                  /* -static-libgcc */
  OPT_static_libgfortran = 1367,             /* -static-libgfortran */
  OPT_static_libgo = 1368,                   /* -static-libgo */
  OPT_static_liblsan = 1369,                 /* -static-liblsan */
  OPT_static_libmpx = 1370,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1371,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1372,               /* -static-libphobos */
  OPT_static_libstdc__ = 1373,               /* -static-libstdc++ */
  OPT_static_libtsan = 1374,                 /* -static-libtsan */
  OPT_static_libubsan = 1375,                /* -static-libubsan */
  OPT_static_pie = 1376,                     /* -static-pie */
  /* OPT_std_c__03 = 1377, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1378, */                /* -std=c++0x */
  OPT_std_c__11 = 1379,                      /* -std=c++11 */
  OPT_std_c__14 = 1380,                      /* -std=c++14 */
  OPT_std_c__17 = 1381,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1382, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1383, */                /* -std=c++1z */
  OPT_std_c__2a = 1384,                      /* -std=c++2a */
  OPT_std_c__98 = 1385,                      /* -std=c++98 */
  OPT_std_c11 = 1386,                        /* -std=c11 */
  OPT_std_c17 = 1387,                        /* -std=c17 */
  /* OPT_std_c18 = 1388, */                  /* -std=c18 */
  /* OPT_std_c1x = 1389, */                  /* -std=c1x */
  OPT_std_c2x = 1390,                        /* -std=c2x */
  /* OPT_std_c89 = 1391, */                  /* -std=c89 */
  OPT_std_c90 = 1392,                        /* -std=c90 */
  OPT_std_c99 = 1393,                        /* -std=c99 */
  /* OPT_std_c9x = 1394, */                  /* -std=c9x */
  OPT_std_f2003 = 1395,                      /* -std=f2003 */
  OPT_std_f2008 = 1396,                      /* -std=f2008 */
  OPT_std_f2008ts = 1397,                    /* -std=f2008ts */
  OPT_std_f2018 = 1398,                      /* -std=f2018 */
  OPT_std_f95 = 1399,                        /* -std=f95 */
  OPT_std_gnu = 1400,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1401, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1402, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1403,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1404,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1405,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1406, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1407, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1408,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1409,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1410,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1411,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1412, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1413, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1414,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1415, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1416,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1417,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1418, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1419, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1420,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1421, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1422, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1423, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1424, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1425, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1426,                     /* -std=legacy */
  OPT_symbol_ = 1427,                        /* -symbol= */
  OPT_symbolic = 1428,                       /* -symbolic */
  OPT_t = 1429,                              /* -t */
  OPT_time = 1430,                           /* -time */
  OPT_time_ = 1431,                          /* -time= */
  OPT_traditional = 1432,                    /* -traditional */
  OPT_traditional_cpp = 1433,                /* -traditional-cpp */
  OPT_tree_stats = 1434,                     /* -tree-stats */
  OPT_trigraphs = 1435,                      /* -trigraphs */
  OPT_type_stats = 1436,                     /* -type-stats */
  OPT_u = 1437,                              /* -u */
  OPT_undef = 1438,                          /* -undef */
  OPT_v = 1439,                              /* -v */
  OPT_version = 1440,                        /* -version */
  OPT_w = 1441,                              /* -w */
  OPT_wrapper = 1442,                        /* -wrapper */
  OPT_x = 1443,                              /* -x */
  OPT_z = 1444,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
